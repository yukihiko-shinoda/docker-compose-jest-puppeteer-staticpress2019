...
This conftest is used for unit tests that don't require WordPress or browser setup.
Unit tests validate code structure, imports, and basic logic without requiring
a live WordPress instance or browser automation.
